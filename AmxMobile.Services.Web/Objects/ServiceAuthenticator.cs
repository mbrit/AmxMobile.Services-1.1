...
{
    internal class ServiceAuthenticator : HttpContextAwareBase
    {
		...
		/// </summary>
		internal static ServiceAuthenticator Current
		{
			get
			{
				if(_current == null)
        ...
        internal string ApiUsername
        {
            get
            {
                return (string)this.Items[ApiUsernameKey];
            }
            set
            {
        ...
        internal string ApiToken
        {
            get
            {
                return (string)this.Items[ApiTokenKey];
            }
            set
            {
